...
<body>
	...
	<c:forEach items="${i}" var="m">
			<center>
				...
				<p>
					<%-- //<h2><in${m.getP_name()}</h2> --%>
					<input type="text" name="p_name" value="${m.getP_name()}" readonly="readonly">
				</p>
				...
				<p>
					<%-- <h2>${m.getP_price()}</h2> --%>
					<input type="text" name="p_price" value="${m.getP_price()}" readonly="readonly">
				</p>
				
				<br>
				<p>
					<%-- <h2>${m.getP_description()}</h2> --%>
					<input type="text" name="p_description" value="${m.getP_description()}" readonly="readonly">
				</p>
				<p>
				...
				<p>
				 ...
				 <p>
					<a class="swd-button" href="addtocartfromwishlist.jsp?id=${m.getId()}">Add to cart</a>
				</p> 
			</center>
			</form>
